...
import register_coco_format_dataset

if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="A script that visualizes the json predictions from COCO dataset."
    )
    parser.add_argument("--input", default='nuinsseg_v1.0-mini.json', help="JSON file produced by the model")
    parser.add_argument("--output", help="output directory")
    parser.add_argument("--show",  default=True, help="show the result")
    parser.add_argument("--dataset", default="nuinsseg_v1.0-mini_val")
